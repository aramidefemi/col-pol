            ...
            <div className="col-md-10 ms-auto me-auto">
              <div className="row mt-4">
                <div className="col-md-3">
                  <div
                    onClick={() => handleClick('/update-school-info')}
                    className="border rounded clickable bg-light-grey text-center p-3"
                  >
                    <img
                      alt=""
                ...
                <div className="col-md-3">
                  <div
                    onClick={() => handleClick('/school-setup')}
                    className="border rounded clickable bg-light-grey text-center p-3"
                  >
                    <img
                      alt=""
                      src="assets/icons/house-black-silhouette-without-door.svg"
                      className="icon-size-lg"
                    />
                    <p>Campuses</p>
                  </div>
                ...
                <div className="col-md-3">
                  <div
                    onClick={() => handleClick('/add-courses')}
                    className="border rounded clickable bg-light-grey text-center p-3"
                  >
                    <img
                      alt=""
                      src="assets/icons/book-set.svg"
                      className="icon-size-lg"
                    />
                    <p>Courses</p>
                  </div>
                ...
                <div className="col-md-3">
                  <div
                    onClick={() => handleClick('/add-school-program')}
                    className="border rounded clickable bg-light-grey text-center p-3"
                  >
                    <img
                      alt=""
                      src="assets/icons/file-xlg.svg"
                      className="icon-size-lg"
                    />
              ...
              <div className="row mt-4">
                ...
                <div className="col-md-3">
                  <div className="border rounded clickable bg-light-grey text-center p-3">
                    <img
                      alt=""
                      src="assets/icons/pantheon-of-rome.svg"
                      className="icon-size-lg"
                    />
                    <p>Departments</p>
                  </div>
              ...
              <div className="row mt-4">
                <div className="col-md-3">
                  <div className="border rounded clickable bg-light-grey text-center p-3">
                    <img
                      alt=""
                      src="assets/icons/book-of-black-cover-closed.svg"
                      className="icon-size-lg"
                    />
                ...
                <div className="col-md-3">
                  <div className="border rounded clickable bg-light-grey text-center p-3">
                    <img
                      alt=""
                      src="assets/icons/reading-book.svg"
                      className="icon-size-lg"
                    />
                    <p>Students</p>
                  </div>
                ...
                <div className="col-md-3">
                  <div className="border rounded clickable bg-light-grey text-center p-3">
                    <img
                      alt=""
                      src="assets/icons/school-building.svg"
                      className="icon-size-lg"
                    />
                    <p>School Programs</p>
                  </div>
                ...
                <div className="col-md-3">
                  <div className="border rounded clickable bg-light-grey text-center p-3">
                    <img
                      alt=""
                      src="assets/icons/school-calendar.svg"
                      className="icon-size-lg"
                    />
                    <p>Semester</p>
                  </div>
