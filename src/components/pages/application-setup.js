          ...
          <div className="row justify-content-center">
            <div className="col-md-10 ms-auto me-auto">
                ...
                <div className="card-body">
                  <div className="row">
                    ...
                    <div className="col-md-4">
                      ...
                      <button className="upload-btn bg-light-grey btn btn-md me-2">
                        Downlad CSV
                      </button>
                      <img alt="" src="assets/icons/info-circle.svg" />
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-8">
                      <div className="row justify-content-center mt-4">
                        <div className="col-md-8 col-10 offset-md-1">
                          <div className="d-grid gap-2">
                            <button
                              className="btn btn-secondary btn-lg fs-6 py-3"
                              type="button"
                            >
                              Upload
                            </button>
                  ...
                  <div className="row justify-content-center">
                    <div className="col-md-12 text-center mt-4">
                      ...
                      <p className="d-inline-block">
                        Note: the CSV allows bulk upload of document in a
                        specific format
                      </p>
                    </div>
                  </div>
              ...
              <div className="row mt-5 justify-content-center">
                <div className="col-md-4">
                  <div className="d-grid gap-2">
                    <button className="btn btn-lg btn-success fs-6">
                      Setup
                    </button>
                  </div>
                </div>
